...
var pendingLogsProcessInterval;
...
async function startTrading() {
  ...
  if (i.success) {
    ...
    pendingLogsProcessInterval = setInterval(processPendingLogs, 2000)
  } else {
...
async function stopTrading() {
  ...
  if (pendingTradeUpdateInterval && pendingLogsProcessInterval) {
    clearInterval(pendingTradeUpdateInterval)
    clearInterval(pendingLogsProcessInterval)
  }
  t.setAttribute("value", "Start Trading")
